...
class CliRepl {
    ...
    async setLoggingEnabled(enabled) {
        ...
        if (enabled) {
            ...
            await ((_a = this.loggingAndTelemetry) === null || _a === void 0 ? void 0 : _a.detachLogger());
        }
    }
    ...
    async close() {
        ...
        return ((_a = this.closingPromise) !== null && _a !== void 0 ? _a : (this.closingPromise = (async () => {
            ...
            await ((_b = this.loggingAndTelemetry) === null || _b === void 0 ? void 0 : _b.flush());
            if (analytics) {
            ...
            (_c = this.logWriter) === null || _c === void 0 ? void 0 : _c.info('MONGOSH', (0, mongodb_log_writer_1.mongoLogId)(1000000045), 'analytics', 'Flushed outstanding data', {
                flushError,
                flushDuration,
            });
            await ((_d = this.logWriter) === null || _d === void 0 ? void 0 : _d.flush());

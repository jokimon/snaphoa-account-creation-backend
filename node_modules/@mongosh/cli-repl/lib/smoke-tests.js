        ...
        try {
            if (!wantPerformanceTesting) {
                ...
                perfResults.push({
                    info: {
                        test_name: name,
                        tags: [...(tags !== null && tags !== void 0 ? tags : []), ...commonPerfTags],
                    },
                    created_at,
                    completed_at,
                    artifacts: [],
            ...
            metrics: [
                {
                    ...
                    type: 'MEAN',
                    value: (await fs_1.promises.stat(process.execPath)).size,
                },
            ],
        });
...
async function runSmokeTest({ name, executable, args, env, input, output, exitCode, includeStderr, printSuccessResults, }) {
    ...
    const metadata = {
        ...
        executable,
        actualExitCode,
        args: args.map((arg) => (0, mongodb_redact_1.redactConnectionString)(arg)),
    };
    try {
